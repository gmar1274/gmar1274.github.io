...
- [x] This app utillizes Font Awesome and skydove's ColorPickerView [<i class="fab fa-github"></i>] (https://github.com/skydoves/ColorPickerView).![logo](https://github.com/gmar1274/MedicineReminder/blob/master/app/src/main/ic_launcher-web.png?raw=true){:height="50px" width="50px vertical-align:middle"}
